                    ...
                    <div class="col-lg-12 login-form">
                        <form action="register.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="confirmPassword" class="form-control" i placeholder="CONFIRM PASSWORD">
                            </div>
                            <div class="col-lg-12 loginbttm">

                                <div class="col-lg-6 login-btm login-button">
                                    <button type="submit" name="register-btn" class="btn btn-outline-primary">REGISTER</button>
                                    ...........
